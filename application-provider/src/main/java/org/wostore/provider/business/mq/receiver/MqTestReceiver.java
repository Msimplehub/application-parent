...
public class MqTestReceiver {
	...
	public static void main(String[] args) {
		MqTestReceiverThread mqTestReceiverThread = new MqTestReceiverThread();
		mqTestReceiverThread.start();
	}
}

class MqTestReceiverThread extends Thread {
...
//			destination = session.createQueue("test");
			...
			while (true) {
				...
				if (null != message) {
					System.out.println("MqTestReceiver收到消息" + message.getText());
				} else {
					break;
				}
			}
